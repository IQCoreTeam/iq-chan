            ...
            {threads.map((thread) => {
                ...
                return (
                    <div key={thread.threadPda}>
                        <div className={`thread${isThreadHidden ? " post-hidden" : ""}`} id={`t${op.__txSignature ?? ""}`}>
                            <img
                                alt={isThreadHidden ? "+" : "-"}
                                className="extButton threadHideButton desktop"
                                ...
                                width={15}
                                height={15}
                                style={{ cursor: "pointer", marginRight: 3, float: "left", marginTop: 3 }}
                            />
